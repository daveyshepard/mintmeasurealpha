...
var os = [
 ...
 function getMintMeasureCookie() {
    var visitorCookie = generateCookieId();
    if (generateCookieId === "") {
 ...
 function createVisitorCookie() {
    ...
    var newCookie =  visitedCookieName + '=' + generateCookieId()+ '; expires=' + getExpiryDate();
 ...
 require('https://cdnjs.cloudflare.com/ajax/libs/fingerprintjs2/2.1.0/fingerprint2.js', () => {
    ...
    var querystring = '?';
    var visitorPixelId = checkForMintMeasureCookie();
    ...
    function createQueryString() {
       ...
       querystring += 'medium=' + 'display' + '&';
       querystring += 'siteId=' + 'AcuityDisplay' + '&';
